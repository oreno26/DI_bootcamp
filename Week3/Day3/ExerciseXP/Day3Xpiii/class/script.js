...
function retrieveZonesAndAddEvents () {
    const sectionDropZone = document.getElementById("section2");
    ...
    sectionDropZone.addEventListener("dragover", overTarget)
    sectionDropZone.addEventListener("drop", dropOnTarget);
}

retrieveZonesAndAddEvents()


function overTarget (evt) {//will  not work without this
...
function dropOnTarget (evt) {
    ...
    //id of the element as a TEXT
    const elem = document.getElementById(data);
    // the actual element by id
