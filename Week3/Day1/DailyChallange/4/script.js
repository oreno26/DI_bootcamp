const allBBooks = [
    ...
    title: "the outsiders",
    author : "S E hinton",
    image : "https://i0.wp.com/booksofbrilliance.com/wp-content/uploads/2021/08/Screen-Shot-2021-08-19-at-2.24.19-AM.png?fit=632%2C942&ssl=1",
    alreadyRead : true
    }, {
        title: "mist",
        author : "Stphen king",
   ...
   // Using the DOM, render the books inside an HTML table 
    ...
    for (let i=0; i <= allBBooks.length-1 ; i++ ){
        ...
        <tbody>
          <tr>
            <td>${allBBooks[i]["title"]} by ${allBBooks[i]["author"]}</td>
            <td>
